      ...
      <main className="flex flex-col items-center w-full">
        <div className="flex flex-col md:flex-row items-center w-full max-w-4xl p-8">
          <div className="w-full md:w-1/2 order-2 md:order-1 mt-10 md:mt-20">
            <Image src="/images/starter-menu.png" alt="Menu Image" width={400} height={400} className="w-full h-auto" />
          </div>
          <div className="w-full md:w-1/2 pl-0 md:pl-8 order-1 md:order-2 mt-10 md:mt-20">
            <div className="flex flex-col items-start mb-4">
              ...
              <h2 className="text-[#333333] font-bold text-2xl md:text-4xl mt-2">Starter Menu</h2>
            </div>
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-xl md:text-2xl font-bold">Alder Grilled Chinook Salmon</h3>
            ...
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-xl md:text-2xl font-bold text-[#FF9F0D]">Berries and Creme Tart</h3>
            ...
            <div className="border-t border-dotted border-gray-500 my-4"></div>
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-xl md:text-2xl font-bold">Tormentoso Bush Pizza Pintoage</h3>
            ...
            <div className="border-t border-dotted border-gray-500 my-4"></div>
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-xl md:text-2xl font-bold">Spicy Vegan Potato Curry</h3>
