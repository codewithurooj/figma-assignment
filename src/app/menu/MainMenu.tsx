        ...
        <div className="flex flex-col md:flex-row items-center w-full max-w-4xl p-8">
          <div className="w-full md:w-1/2 pr-0 md:pr-8 mt-10 md:mt-20">
            <div className="flex flex-col items-start mb-4">
              ...
              <h2 className="text-[#333333] font-bold text-2xl md:text-4xl mt-2">Main Course</h2>
            </div>
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-xl md:text-2xl font-bold">Optic Big Breakfast Combo Menu</h3>
            ...
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-xl md:text-2xl font-bold">Cashew Chicken With <br className="hidden md:block" /> Stir-Fry</h3>
            ...
            <div className="border-t border-dotted border-gray-500 my-4"></div>
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-xl md:text-2xl font-bold">Vegetables & Green Salad</h3>
          ...
          <div className="w-full md:w-1/2 mt-10 md:mt-20">
            <Image src="/images/main-menu.png" alt="Menu Image" 
